...
public class JoinCESAPIValidation 
{
	...
	public void verifyProviderApplicationAccountDetails(String cesproviderStatus, String cesmembershipType, String enddate,
		...
		System.out.println("ProviderApp response:"+responseMembership);
        Thread.sleep(30000);
	//	jsonPathEval = responseMembership.jsonPath();
		...
		String cES_Subscription_Type = jsonPathEval.getString("AIA_CES_Subscription_Type__c");
		Boolean isRenewEligible = jsonPathEval.getBoolean("AIA_CES_Renew_Eligible__c");
		String grace_Period_End_Date__c = jsonPathEval.getString("OrderApi__Grace_Period_End_Date__c");
		String termStartDate = jsonPathEval.getString("OrderApi__Term_Start_Date__c");
		String termEndDate = jsonPathEval.getString("OrderApi__Term_End_Date__c");
		String paidThroughDate = jsonPathEval.getString("OrderApi__Paid_Through_Date__c");
		Double daysToLapse = jsonPathEval.getDouble("OrderApi__Days_To_Lapse__c");
		String membershipType = jsonPathEval.getString("Membership_Type__c");

		System.out.println("=====================================");
		System.out.println("Membership type :" + membershipType);
		System.out.println("Membership start date :" + termStartDate);
		System.out.println("Membership end date :" + termEndDate);
		System.out.println("Membership daysToLapse :" + daysToLapse);
		System.out.println("Membership CES Subscription Type :" + cES_Subscription_Type);
		System.out.println("=====================================");

		assertEquals(membershipType, cesmembershipType);
		assertEquals(cES_Subscription_Type, cesmembershipType);
