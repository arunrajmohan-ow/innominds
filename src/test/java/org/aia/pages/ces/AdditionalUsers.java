...
public class AdditionalUsers {
	...
	@FindBy(xpath = "//input[@value='newUser']/following-sibling::label/span[1]")
	WebElement createnewUserRdobtn;

	@FindBy(xpath = "//input[@value='noUser']/following-sibling::label/span[1]")
	WebElement doneCreatingUsers;

	@FindBy(xpath = "//div/button[1]/text()/parent::button")
	WebElement additionalPrevious;

	@FindBy(xpath = "//button[text()='Next']")
	WebElement additionalNext;

	@FindBy(xpath = "//*[@class = 'row slds-hint-parent'][1]//div")
	List<WebElement> primRowDetails;

	@FindBy(xpath = "//div/span[@class='main']")
	WebElement tabTitleAUP;
	...
	public void verifyAdditionalUserTab() throws Exception {
		util.waitUntilElement(driver, createnewUserRdobtn);
		Thread.sleep(2000);
		createnewUserRdobtn.click();
		additionalNext.click();
	...
	public void verifyAUTab() {
		util.waitUntilElement(driver, tabTitleAUP);
		assertTrue(tabTitleAUP.isDisplayed());
