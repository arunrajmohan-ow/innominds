...
WebDriver driver;
	...
	@FindBy(xpath="//div[text()='Payment Successful']") WebElement paymentSucessfulMessage;
	
	@FindBy(xpath="//span[text()='View Receipt']/parent::button") WebElement viewReceiptBtn;
	
	@FindBy(xpath="//span[@class = 'currencyInputSpan FrameworkCurrencyField']") WebElement paymentTotalTxt;
