...
public class OrderSummaryPage {
	...
	@FindBy(xpath="//*[@id='menu-subscriptionPlanId']/div[3]/ul/li[text()=6][1]") WebElement sixInstallments;
	...
	@FindBy(xpath="//*[@id=\"memberTypeLabel\"]") WebElement supplementalDuesRdoBtn;
	
	// Renew - chapter assesses supplemental dues for membership
	
	@FindBy(xpath="//*[@id=\"memberName\"]") WebElement memberName;
	
	@FindBy(xpath="//*[@id=\"memberId\"]") WebElement memberNumber;
	
	@FindBy(xpath="//*[@id=\"nonMemberArchitectCount\"]") WebElement nonMemberArchitectCount;
	
	@FindBy(xpath="//*[@id=\"technicalStaffCount\"]") WebElement technicalStaffCount;
	
	@FindBy(xpath="//*[@id=\"otherStaffCount\"]") WebElement otherStaffCount;
	...
	public void selectRadioBtnByValue( String string) {
		...
		{
		case "architecturalFirmOwner" :  	value= "I own or manage an architectural firm.";
		break;
		case "solePractitioner":  value= "I am a sole practitioner.";
		break;
		case "architectureFirmManager":  			value= "I own or manage an architecture firm and designate another AIA member to pay the supplemental dues my firm owes.";
		break;
		case "notSolePractitioner":  				value= "I am not a sole practitioner, and I do not own or manage an architecture firm.";
		break;
		}
	...
	public void enterSupplementalDuesDetails(String radbtnString, String nonMemberCount,  String StaffCount, String otherCount) throws InterruptedException {
		...
		else if(radbtnString.contentEquals("architecturalFirmOwner")||radbtnString.contentEquals("solePractitioner"))
		{
