...
public class TellusAboutYourselfPage {
	...
	@FindBy(xpath="//h1[text()='Tell us about yourself.']") WebElement TellUsAbtLabelTellpage;
	
	@FindBy(xpath="//button[@name='AIA_Career_Type__c']") WebElement CareeTypTellpage;
	
	@FindBy(xpath="//span[@title='Non profit']/parent::span") WebElement nonProfitCarTypTellpage;
	
	@FindBy(xpath="//span[@title='For Profit']/parent::span") WebElement forProfitCarTypTellpage;
	
	@FindBy(xpath="//span[@title='Govt']/parent::span") WebElement govtCarTypTellpage;
	
	@FindBy(xpath="//span[@title='Education']/parent::span") WebElement educatnCarTypTellpage;
	
	@FindBy(xpath="//span[@title='Retired']/parent::span") WebElement retiredCarTypTellpage;
	...
	@FindBy(xpath="//label[text()='Home street']/parent::div/following-sibling::div[1]") WebElement homestreetTellpage;
	
	@FindBy(xpath="//label[text()='Home street']/parent::div/following-sibling::div[2]/div/lightning-input") WebElement homeCityTellpage; 
	
	@FindBy(xpath="//label[text()='State']/parent::div/following-sibling::lightning-combobox") WebElement stateTellpage;	

	@FindBy(xpath="//label[text()='State of license']/following-sibling::lightning-input-field") WebElement stateOfLicenceTellpage;

	@FindBy(xpath="//label[text()='State']/parent::div/following-sibling::lightning-combobox//span[@title='California']") WebElement californiaStateTellpage;

	@FindBy(xpath="//label[text()='State of license']/following-sibling::lightning-input-field//lightning-base-combobox/div/div[2]//span[@title='California']") WebElement californiaStateLicenceTellpage;
	
	@FindBy(xpath="//label[text()='Country of license']/following-sibling::lightning-input-field") WebElement countryOfLicenseTellpage;

	@FindBy(xpath="//label[text()='State Of License']/parent::div/following-sibling::div[1]//lightning-base-combobox/div/div[2]//span[@title='United States']/parent::span") WebElement countryLicenseUSTellpage;
	
	@FindBy(xpath="//label[text()='State']/parent::div/following-sibling::lightning-combobox") WebElement licencestateTellpage;
		
	@FindBy(xpath="//*[@name='Join_License_Expire_Date__c']") WebElement LicenceExpiryDateTellPage;
	
	@FindBy(xpath="//label[text()='Supervisor']/following-sibling::lightning-input-field") WebElement supervisorTellPage;
	
	@FindBy(xpath="//label[text()='Supervisor email']/following-sibling::lightning-input-field//div/input") WebElement supervisorEmailTellPage;
	
	@FindBy(xpath="//label[text()='License number']/following-sibling::lightning-input-field") WebElement licenseNumTellpage;
